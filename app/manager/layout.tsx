      ...
      <div className="flex min-h-screen">
        <aside className="w-56 bg-zinc-900 border-r border-zinc-800 p-4 text-sm">
          ...
          <nav className="space-y-2">
            <a href="/manager" className="block text-zinc-300 hover:text-white">
              대시보드
            </a>
            <a href="/manager/guests" className="block text-zinc-300 hover:text-white">
              하객 관리
            </a>
            <a href="/manager/settings" className="block text-zinc-300 hover:text-white">
              환경 설정
            </a>
          </nav>
        </aside>
